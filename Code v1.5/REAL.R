...
#' Output: posteriors for the selection coefficient, dominance parameter and the genotype frequency trajectories of the population
...
dom_par_chn <- PMMH$dom_par_chn
frq_pth_chn <- PMMH$frq_pth_chn

pdf(file = "./REAL_COL_ASIP_1_Traceplot.pdf", width = 24, height = 12)
...
plot(1:itn_num, dom_par_chn[1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Dominance parameter",
     main = "Trace plot for dominance parameter")
dev.off()
...
dom_par_est <- mean(dom_par_chn)

dom_par_hpd <- HPDinterval(as.mcmc(dom_par_chn), prob = 0.95)

pdf(file = "./REAL_COL_ASIP_1_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
lines(density(dom_par_chn), lwd = 2, col = 'black')
abline(v = dom_par_est, col = 'black', lty = 2, lwd = 2)
abline(v = dom_par_hpd[1], col = 'blue', lty = 2, lwd = 2)
abline(v = dom_par_hpd[2], col = 'blue', lty = 2, lwd = 2)
dev.off()
...
pdf(file = "./REAL_COL_ASIP_2_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./REAL_COL_ASIP_2_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_COL_ASIP_3_Traceplot.pdf", width = 24, height = 6)
...
pdf(file = "./REAL_COL_ASIP_3_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_COL_MC1R_1_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./REAL_COL_MC1R_1_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_COL_MC1R_2_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./REAL_COL_MC1R_2_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_COL_MC1R_3_Traceplot.pdf", width = 24, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient")
...
pdf(file = "./REAL_COL_MC1R_3_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_KIT13_1_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
...
pdf(file = "./REAL_PTN_KIT13_1_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_KIT13_2_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before the Middle Ages")
...
pdf(file = "./REAL_PTN_KIT13_2_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_KIT13_3_Traceplot.pdf", width = 24, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient")
...
pdf(file = "./REAL_PTN_KIT13_3_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_KIT16_1_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before the Middle Ages")
...
pdf(file = "./REAL_PTN_KIT16_1_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_KIT16_2_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before the Middle Ages")
...
pdf(file = "./REAL_PTN_KIT16_2_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_KIT16_3_Traceplot.pdf", width = 24, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient")
...
pdf(file = "./REAL_PTN_KIT16_3_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_TRPM1_1_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./REAL_PTN_TRPM1_1_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./REAL_PTN_TRPM1_1_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./REAL_PTN_TRPM1_1_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_TRPM1_1_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
smp_gen <- min(unique(raw_smp$age_mean)):max(unique(raw_smp$age_mean))
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
...
pdf(file = "./REAL_PTN_TRPM1_2_Traceplot.pdf", width = 24, height = 12)
par(mfrow = c(2, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before domestication")
...
pdf(file = "./REAL_PTN_TRPM1_2_Posterior_SelCoeff.pdf", width = 24, height = 12)
par(mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
layout(matrix(c(1, 1, 2, 3), nrow = 2, ncol = 2))
grd_num <- 1e+03
sel_cof_pdf <- kde2d(sel_cof_chn[1, ], sel_cof_chn[2, ], n = grd_num)
...
pdf(file = "./REAL_PTN_TRPM1_2_Posterior_SelChange.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dif_sel_chn, breaks = seq(min(dif_sel_chn), max(dif_sel_chn), length.out = 50), freq = FALSE,
     xlab = "Change in selection coefficient",
     main = "Posterior for change in selection coefficient")
...
pdf(file = "./REAL_PTN_TRPM1_2_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
pdf(file = "./REAL_PTN_TRPM1_2_Posterior_Traj.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
smp_gen <- min(unique(raw_smp$age_mean)):max(unique(raw_smp$age_mean))
plot(0, type = 'n', xlim = c(min(smp_gen), max(smp_gen)), ylim = c(min(frq_pth_chn), max(frq_pth_chn)),
     xlab = "Generation", ylab = "Allele frequency",
...
pdf(file = "./REAL_PTN_TRPM1_3_Traceplot.pdf", width = 24, height = 6)
par(mfrow = c(1, 2), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient")
...
pdf(file = "./REAL_PTN_TRPM1_3_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
