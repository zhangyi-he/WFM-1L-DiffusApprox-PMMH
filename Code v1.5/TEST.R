...
pdf(file = "./TEST_PMMH_Traceplot.pdf", width = 8, height = 18)
...
abline(h = dom_par, col = 'red', lty = 2, lwd = 2)
dev.off()
...
pdf(file = "./TEST_PMMH_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
abline(v = dom_par, col = 'red', lty = 2, lwd = 2)
...
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(0, type = 'n', xlim = c(min(raw_smp[, 1]), max(raw_smp[, 1])), ylim = c(min(frq_pth_chn, sim_HMM_WFM$mut_frq), max(frq_pth_chn, sim_HMM_WFM$mut_frq)),
     xlab = "Generation", ylab = "Allele frequency",
     main = "Posterior for underlying trajectory of mutant allele")
for (i in 1:dim(frq_pth_chn)[1]) {
  lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_chn[i, ], col = 'grey', lty = 1, lwd = 2)
}
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), sim_HMM_WFM$mut_frq, col = 'red', lty = 1, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_est, col = 'black', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[1, ], col = 'blue', lty = 2, lwd = 2)
lines(min(raw_smp[, 1]):max(raw_smp[, 1]), frq_pth_hpd[2, ], col = 'blue', lty = 2, lwd = 2)
dev.off()
...
pdf(file = "./TEST_AdaptPMMH_Traceplot.pdf", width = 8, height = 18)
par(mfrow = c(3, 1), mar = c(5.5, 5, 5.5, 2.5), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
plot(1:itn_num, sel_cof_chn[1, 1:itn_num], type = 'l',
     xlab = "Iteration", ylab = "Selection coefficient",
     main = "Trace plot for selection coefficient before event")
...
pdf(file = "./TEST_AdaptPMMH_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
...
dom_par_chn <- BayesianProcedure$dom_par_chn
dom_par_est <- BayesianProcedure$dom_par_est
dom_par_hpd <- BayesianProcedure$dom_par_hpd

pdf(file = "./TEST_BayesProc_Posterior_DomParam.pdf", width = 12, height = 6)
par(mar = c(5.1, 5.1, 4.1, 1.1), cex.main = 1.75, cex.sub = 1.5, cex.axis = 1.5, cex.lab = 1.5)
hist(dom_par_chn, breaks = seq(min(dom_par_chn), max(dom_par_chn), length.out = 50), freq = FALSE,
     xlab = "Dominance parameter",
     main = "Posterior for dominance parameter")
